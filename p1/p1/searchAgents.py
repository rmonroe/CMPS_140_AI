...
class CornersProblem(search.SearchProblem):
  ...
  def startingState(self):
    ...
    "*** Your Code Here ***"
    # set the starating position and all corners to false(unvisited)
  ...
  def isGoal(self, state):
    ...
    "*** Your Code Here ***"
    # have all the corners been visisted
      ...
      if not self.walls[nextx][nexty]:
          ...
          if (nextx, nexty) in self.corners:
              ...
              if (nextx, nexty) == self.corners[0]:
                  ...
                  tempCorners[3] = True
          # pass the next pos and the current checklist of corners
          nextState= ((nextx,nexty), tempCorners)
          # append the state to the list of successors w/ the list of cornersVisited
          succ.append((nextState, action, 1))
    self._expanded += 1
    return succ
